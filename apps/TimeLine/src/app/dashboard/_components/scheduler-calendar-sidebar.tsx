...
export function SchedulerCalendarSidebar({ calendarMonth, focusedDate, isCalendarOpen, monthDays, onSelectDay, onToday, setCalendarMonth, summaryContent, viewMode, weekStart }: SchedulerCalendarSidebarProps) {
  const helperText = viewMode === 'day' ? 'Өдөр сонгоод баруун талын timeline-г шинэчилнэ' : viewMode === 'month' ? 'Өдөр дарвал өдрийн харагдац руу орно' : viewMode === 'year' ? 'Сар дарвал сарын харагдац руу шилжинэ' : `Сонгосон 7 хоног: ${formatShortDate(weekStart)} - ${formatShortDate(addDays(weekStart, 6))}`
